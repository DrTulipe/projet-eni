...
// node_modules/@fullcalendar/core/internal-common.esm.js
  ...
  render() {
    ...
    return h(ViewContextType.Consumer, null, (context) => {
      ...
      return h(
        ...
        state.isPopoverOpen && h(MorePopover, { id: state.popoverId, startDate: range.start, endDate: range.end, dateProfile: props.dateProfile, todayRange: props.todayRange, extraDateSpan: props.extraDateSpan, parentEl: this.parentEl, alignmentEl: props.alignmentElRef ? props.alignmentElRef.current : this.linkEl, alignGridTop: props.alignGridTop, onClose: this.handlePopoverClose }, props.popoverContent())
      );
    });
  }
  componentDidMount() {
...
// node_modules/@fullcalendar/core/index.esm.js
...
//# sourceMappingURL=chunk-M6GPGHLG.js.map
